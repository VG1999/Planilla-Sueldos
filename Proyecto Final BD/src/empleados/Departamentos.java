...
public class Departamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INGRESO DEPARTAMENTOS");
        ...
        txtCodigoDepto.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtCodigoDepto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCodigoDeptoActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCodigoDepto, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtCodigoDepto, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel4.setText("Ingresa el codigo del departamento: ");
    ...
    private void txtCodigoDeptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodigoDeptoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCodigoDeptoActionPerformed

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        //Codigo que permite borrar registros en la base de datos
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/empleados", "root", "");
            PreparedStatement pst = cn.prepareStatement("delete from departamentos where depCodigo = ?");
    ...
    private void RegistroDeptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroDeptoActionPerformed
        ...
        if(txtCodigoDepto.getText().equals("")){
        ...
        try{
            ...
            pst.setString(1, txtCodigoDepto.getText().trim());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
       ...
       if(txtbuscar.getText().equals("")){
        ...
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/empleados", "root", "");
            PreparedStatement pst = cn.prepareStatement("update departamentos set  depCodigo = ?, depNombre = ?, depStatus=? where depCodigo= " + id);
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        try{
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/empleados", "root", "");
            PreparedStatement pst = cn.prepareStatement("select * from departamentos where depCodigo = ?");
            pst.setString(1, txtbuscar.getText().trim());
            ResultSet rs = pst.executeQuery();

            if(rs.next()){
                txtCodigoDepto.setText(rs.getString("depCodigo"));
                txtDepartamento.setText(rs.getString("depNombre"));
                txtStatus.setText(rs.getString("depStatus"));
