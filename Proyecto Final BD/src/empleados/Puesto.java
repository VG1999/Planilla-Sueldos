...
public class Puesto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("INGRESO PUESTOS");
        ...
        jLabel1.setText("Cod Puesto");

        txtCodPuesto.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtCodPuesto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCodPuestoActionPerformed(evt);
            }
        });
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/obrero.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtCodPuesto, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtCodPuesto, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtCodPuestoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodPuestoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtCodPuestoActionPerformed

    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        //Codigo que permite borrar registros en la base de datos
        try {
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/empleados", "root", "");
            PreparedStatement pst = cn.prepareStatement("delete from Puesto where CodigoPuesto = ?");
    ...
    private void RegistroDeptoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroDeptoActionPerformed
        ...
        if(txtCodPuesto.getText().equals("")){

            JOptionPane.showMessageDialog(null,"Ingrese el Codigo");
        }
        if(txtPuesto.getText().equals("")){

            JOptionPane.showMessageDialog(null,"Ingrese la Puesto");
        }
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Registro del puesto existoso");
        }catch (Exception e){
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/empleados", "root", "");
            PreparedStatement pst = cn.prepareStatement("update Puestos set  CodigoPuesto = ?, NombrePuesto = ? where CodigoPuesto = " + id);
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        try{
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/empleados", "root", "");
            PreparedStatement pst = cn.prepareStatement("select * from Puesto where CodigoPuesto = ?");
            pst.setString(1, txtbuscar.getText().trim());
            ResultSet rs = pst.executeQuery();

            if(rs.next()){
                txtCodPuesto.setText(rs.getString("CodigoPuesto"));
